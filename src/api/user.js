...
export const inviteUser = ({ firstName, lastName, email, payType, hourlyRate, salaryRate } = {}) =>
  apiFetch("/api/user", { method: "POST", body: { firstName, lastName, email, payType, hourlyRate, salaryRate } });
